...
APPS_DIR = BASE_DIR / "django_educational_demo_application"
env = environ.Env()
...
DATABASES = {
    "default": env.db(
        "DATABASE_URL",
        default="postgres:///django_educational_demo_application",
    ),
}
...
LOCAL_APPS = [
    "django_educational_demo_application.users",
    "django_educational_demo_application.projects",
]
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "django_educational_demo_application.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
ADMINS = [("""Alexey Kuzko""", "466399@niuitmo.ru")]
